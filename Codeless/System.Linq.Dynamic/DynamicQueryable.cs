...
namespace System.Linq.Dynamic {
  ...
  public sealed class ParseException : Exception {
    ...
    public override string ToString() {
      return string.Format(Resources.ParseExceptionFormat, Message, position);
    }
  }
...
#pragma warning restore 0219
    ...
    Expression ParseParenExpression() {
      ValidateToken(TokenId.OpenParen, Resources.OpenParenExpected);
      NextToken();
      Expression e = ParseExpression();
      ValidateToken(TokenId.CloseParen, Resources.CloseParenOrOperatorExpected);
      NextToken();
      return e;
    }
    ...
    Expression ParseNew() {
      ...
      ValidateToken(TokenId.CloseParen, Resources.CloseParenOrCommaExpected);
      NextToken();
    ...
    Expression ParseTypeAccess(Type type) {
      ...
      ValidateToken(TokenId.Dot, Resources.DotOrOpenParenExpected);
      NextToken();
        ...
        switch (FindMethod(type, id, instance == null, args, out mb)) {
          ...
          case 1:
            ...
            if (!IsPredefinedType(method.DeclaringType))
              throw ParseError(errorPos, Resources.MethodsAreInaccessible, GetTypeName(method.DeclaringType));
            if (method.ReturnType == typeof(void))
              throw ParseError(errorPos, Resources.MethodIsVoid,
    ...
    Expression ParseElementAccess(Expression expr) {
      int errorPos = token.pos;
      ValidateToken(TokenId.OpenBracket, Resources.OpenParenExpected);
      NextToken();
